package org.wingsofcarolina.groups.persistence;

import java.util.List;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.wingsofcarolina.groups.domain.AutoIncrement;
...
public class Persistence {
	...
	public Persistence initialize(String mongodb) {
		if (instance == null) {
			...
			datastore.getMapper().mapPackage("org.wingsofcarolina.domain");
